...
/**
 * @author Truong Pham, Jatar, Jatar
 */
public class ActionListenersControl {
    ...
    /**
     * DeleteFunction 1 Main 2 NewGame 3 Play 4 PlayOptions 5 SavedGame 6
     * UserFunction 7
     */
    /**
    ...
    /**
     * Initializes the boolean used for various states such as inserting,
     * deleting...etc
     */
    ...
    /**
     * Add the event handlers for the error dialog screen's compoenents during
     * running
     *
     * @author Truong, Carlos
     */
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (!text.isEmpty()) {
                    ...
                    if (Backend.gameExists(text)) {
                        ...
                        errorDialog.errorL.setText("Introduce un nombre que aun no exista.");
                        newGame.hide();
                        errorDialog.show();
                    } else {
                    ...
                    parentScreen = NEWGAME;
                    errorDialog.errorL.setText("Introduce un nombre valido de juego");
                    newGame.hide();
                    errorDialog.show();
                }
        ...
        okNoDialog.addOkEventHandler(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    System.out.println("Imposible guardar el juego.");
                }
     ...
     *
     * @author Jatar, Jatar, Truong, Carlos
     */
    private void addPlayEventHandlers() {
        ...
        playScreen.addMenuEventHandler(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                okNoDialog.okNoDialogL.setText("Te gustaria guardar el juego actual?");
                okNoDialog.show();
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                Thread thread = new Thread() {
                    public void run() {
                        ...
                        if (stop) {
                            errorDialogRun.errorL.setText("El programa se ha detenido. Se reiniciara");
                            errorDialogRun.show();
                        } else if (errortype == 1) {
                            ...
                            errorDialogRun.errorL.setText("Imposible comer: No hay comida en ese espacio.");
                            errorDialogRun.show();
                        } else if (errortype == 2) {
							//ERROR: insert Dialogue BoxCannot Move Forward bc there is WALL
                            //HIGHLIGHT the error block using lineNumbers.get(error+1);
                            Play.setSelectedIndexColor(lineNumbers.get(error + 1), 'e');
                            errorDialogRun.errorL.setText("Imposible avanzar: Hay un obstaculo adelante.");
                            errorDialogRun.show();
                        } else if (errortype == 3) {
                            //miscellaneous error, could not compile code(this shouldn't happen)
                        } else if (errortype == 4) {
                            //ERROR: insert Dialogue BoxDid not reach water/goal
                            errorDialogRun.errorL.setText("Aun no alcanzas el agua, sigue intentando!");
                            errorDialogRun.show();
                        } else if (errortype == -1) {
                            ...
                            errorDialogRun.errorL.setText("Creaste un ciclo infinito. Edita tu codigo");
                            errorDialogRun.show();
                        } else if (errortype == 0) {
                            //WIN THE GAME
                            Start.StartGerbil.controller.resetTempGrid();
        ...
        playScreen.addEditEventHandler(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                parentScreen = PLAY;
                errorDialogRun.errorL.setText("Editar es para debiles.");
                errorDialogRun.show();
                ...
                if (inserting == true) {
                    ...
                    if (newType.equals("If")) {
                        ...
                        if (ret == 4) { //DO NOT OPEN CONDITIONALS = show error dialog!!!!
                            parentScreen = PLAY;
                            errorDialog.errorL.setText("Error: 'If' no esta presente y es necesario para 'Else If' o 'Else'");
                            errorDialog.show();
                        } else if (ret == 5) {//DO NOT OPEN CONDITIONALS = show error dialog!!!!
                            parentScreen = PLAY;

                            errorDialog.errorL.setText("Error: Necesario insertar 'Else If' o 'Else' despues del condicional 'If'");
                            errorDialog.show();
    ...
    private void addSavedGamesEventHandlers() {
        savedGames.addOpenGameEventHandler(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (oGame == null) {
                    parentScreen = 6;
                    errorDialog.errorL.setText("Se debe seleccionar un juego");
                    errorDialog.show();
                } else {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (!functionName.equals("")) {
                    ...
                    if (error == 1) {
                        ...
                        errorDialog.errorL.setText("El nombre solo debe tener letras/numeros");
                        errorDialog.show();
                    } else if (error == 2) {
                        parentScreen = USERFUNCTION;
                        //error: function name already exists, choose another
                        errorDialog.errorL.setText("Este nombre ya existe, porfavor introduce otro");
                        errorDialog.show();
                    } else {
                        parentScreen = PLAY;
                    ...
                    parentScreen = USERFUNCTION;
                    errorDialog.errorL.setText("Debes introducir el nombre de la Funcion");
                    errorDialog.show();
                }
    ...
    /**
     * DeleteFunction 1 Main 2 NewGame 3 Play 4 PlayOptions 5 SavedGame 6
     * UserFunction 7 Show parent method to make it easier to go back a screen
     * using enumeration
     *
     * @author Jatar
     */
