...
public class Finish extends Screen {
	...
	public void setPanel(){
		...
		reachedTheEnd = new JLabel("Has llegado al agua!");
	...
	public void setFruitCount(int i){
		this.fruitCount=i;
		fruitCounter.setText("Frutas consumidas: " + i);
                fruitCounter.setForeground(Color.red);
	}
}