...
public class Conditionals {
	...
	JLabel conditionalsL = new JLabel("Declaraciones Condicionales"); 	
	JLabel givenFunctionsL = new JLabel("Funciones Dadas"); 
	JLabel userDefinedL = new JLabel("Funciones de Usuario");
	...
	public void setText(String type){
		String [] conditions = {"Hay un muro", "No hay un muro", "Hay comida","No hay comida"};
