...
public class Play extends Screen{
	...
	protected static void createAndShowGUI() { 
		frame = new JFrame("Jugar"); // EDIT: User defined game name?
	...
	public static void setLowerComponents(){
		...
		createFunctionB.setText("Crear Funcion");
		deleteFunctionB.setText("Borrar Funcion");
		...
		String [] checks = {"Hay un muro", "No hay un muro", "Hay comida","No hay comida"};
		...
		conditionalStatementsL = new JLabel("<html>Declaraciones </br> Condicionales<html>");
		givenFunctionsL = new JLabel("Funciones Dadas");
		userDefinedFunctionsL = new JLabel("<html>Funciones de Usuario</html>");
		checksL = new JLabel("Comprobaciones");
		numsL = new JLabel("Numeros");
