...
public class SavedGames extends Screen{
	...
	public SavedGames(){
		...
		createButtons();
		gamesLabel = new JLabel("Juegos Guardados");
		...
		frame = new JFrame("Juegos Guardados");
		try {
			image = ImageIO.read(new File("pics/background.jpg"));
		} catch (Exception ex) {
			System.out.println("Imposible cargar imagen");
		} 
